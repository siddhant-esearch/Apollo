...
<div class="container-fluid pt-8">
   ...
   <div class="row">
     ...
     <div class="card-body">
        <form action="{{ url('/add-slider-details') }}" method="post" name="form1"  onsubmit="return validateForm()"  enctype="multipart/form-data">
  @csrf
     <div class="row">
     <div class="col-md-6">
     ...
     <input type="text" class="form-control" name="heading" id="heading"  autocomplete="off">
     </div>
     </div>
      <div class="col-md-6">
     <div class="form-group">
