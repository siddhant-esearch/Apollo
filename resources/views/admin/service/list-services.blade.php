...
<div class="row">
  <div class="col-md-12">
   <div class="card shadow"> 
        ...
        <div class="col-md-12">
          <div class="row">
           <div class="col-md-6" style="text-align: center;">
            <div class="container">
              <img src="{{url('/images')}}/banner/{{$databanner ? $databanner->service_banner : ''}}" alt="Snow">
            </div>
            ...
            <div class="modal fade" id="exampleModal1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
             <div class="modal-dialog modal-dialog-centered" role="document">
               <div class="modal-content">
                 ...
                 <form action="{{url('/update-service-banner')}}" method="post" enctype="multipart/form-data">
                  @csrf
                  <div class="modal-body">
                   <div style="overflow-x:auto;">
                     <input type="file" class="form-control" name="service_banner" id="service_banner" required />
                   </div>
                 </div>
         ...
         <div class="col-md-6" style="text-align: center;">
          <div class="container">
           <img src="{{url('/images')}}/banner/{{$databanner ? $databanner->service_from_pic : ''}}" alt="Snow">
         ...
         <div class="modal fade" id="exampleModal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabe2" aria-hidden="true">
           <div class="modal-dialog modal-dialog-centered" role="document">
             <div class="modal-content">
               ...
               <form action="{{url('/update-service-picture')}}"  method="post" enctype="multipart/form-data">
                @csrf
                <div class="modal-body">
                 <div style="overflow-x:auto;">
                   <input type="file" class="form-control" name="service_from_pic" id="service_from_pic" required />
                 </div>
               </div>
               <div class="modal-footer">
                 <button class="btn btn-primary">
     ...
     <form style="margin-top: 58px;" action="{{url('/update-service-dis')}}"  method="post">
       @csrf
       <div class="col-md-12">
        <div class="form-group mb-0">
          <label class="form-label">Description</label>
          <textarea class="form-control" rows="5" name="service_dis" id="service_dis">{{$databanner ? $databanner->service_dis : ''}}</textarea>
        </div>
      </div>
      <div class="col-md-12">
...
<div class="row">
  <div class="col-md-12">
   <div class="card shadow"> 
     <div class="card-body">
     <h2 class="mb-0">Service Details Page</h2>
      <div class="table-responsive">
        <div class="col-md-12">
          <div class="row">
          <div class="col-md-3">
           ...
           <div class="col-md-6" style="text-align: center;">
            <div class="container">
              <img src="{{url('/images')}}/banner/{{$databanner ? $databanner->service_details_banner : ''}}" alt="Snow">
            </div>
            ...
            <div class="modal fade" id="exampleModalservice" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
             <div class="modal-dialog modal-dialog-centered" role="document">
               <div class="modal-content">
                 ...
                 <form action="{{url('/update-service-details-banner')}}" method="post" enctype="multipart/form-data">
                  @csrf
                  <div class="modal-body">
                   <div style="overflow-x:auto;">
                     <input type="file" class="form-control" name="service_details_banner" id="service_details_banner" required />
                   </div>
                 </div>
                 <div class="modal-footer">
                   <button class="btn btn-primary">
     ...
     <form style="margin-top: 58px;" action="{{url('/update-service-banner-dis')}}"  method="post">
       ...
       <div class="col-md-12">
        <div class="form-group mb-0">
          <label class="form-label">Description</label>
          <textarea class="form-control" rows="5" name="service_banner_dis" id="service_banner_dis">{{$databanner ? $databanner->service_banner_dis : ''}}</textarea>
        </div>
      </div>
      <div class="col-md-12">
        <div class="form-group mb-0" style="margin-top: 70px;">
    ...
    <div class="table-responsive">
     <table id="example" class="table table-striped table-bordered w-100 text-nowrap">
      ...
      <tbody> 
        ...
        <?php $i=1; ?>
        @foreach($dataservice as $mydata)      
        <tr>
          <td><?php  echo $i;?></td>
          <td><img src="{{url('/images')}}/service/{{$mydata ? $mydata->service_image : ''}}" style="width: 250px;"></td>
          <td style="white-space: break-spaces; word-wrap:break-word;">{{$mydata ? $mydata->service_name : ''}}</td>
          <td  style="white-space: break-spaces; word-wrap:break-word;">{{$mydata ? $mydata->service_discription : ''}}</td>
          <td>
                    ...
                    <div class="row">  
                      <div class="col-md-12">
                       <div class="form-group">
                         ...
                         <input class="form-control" type="file" id="service_image" name=" " value="{{$mydata ? $mydata->service_image : ''}}">
                     ...
                     <div class="col-md-12">
                       <div class="form-group">
                         ...
                         <input class="form-control " type="text" id="service_name" name="service_name"  value="{{$mydata ? $mydata->service_name : ''}}">
                       </div>
                     </div>
                     <div class="col-md-12">
                       <div class="form-group">
                         <label for="name">Service Descripation:</label>
                         <textarea class="form-control " type="text" id="service_discription" name="service_discription" rows="5">{{$mydata ? $mydata->service_discription : ''}}</textarea>
                       </div>
                     </div>
                   </div>
                 </div>   
